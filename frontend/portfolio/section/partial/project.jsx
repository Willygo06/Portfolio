  ...
  <section id="projets" className="projects-section">
    ...
    <div className="project-row">
      <div className="project-image-container">
        <img className="ecotrack" src="/src/assets/EcoTrack.jpg" alt="ÉcoTrack" />
      </div>
    ...
    <div className="project-row reverse">
      <div className="project-image-container">
        <img className="projet-irc" src="/src/assets/Projet-IRC.png" alt="Projet IRC" />
      </div>
      <div className="project-content">
        <h3>Projet IRC</h3>
        <p className="project-notes">
    ...
    <div className="project-row reverse">
      <div className="project-image-container">
        <img className="quest" src="/src/assets/Quest.png" alt="Quest" />
      </div>
      <div className="project-content">
        <h3>Quest</h3>
        <p className="project-notes">
